...
package com.roach.framework.cache;
...
import com.roach.framework.util.VersionUtils;
...
public class ImageCache {
    ...
    public void addBitmapToCache(String data, Bitmap bitmap) {
    	addBitmapToCache(data,bitmap,true,true);
    }
     ...
     * @param bitmap The bitmap to store
     */
    public void addBitmapToCache(String data, Bitmap bitmap,boolean memoryCache,boolean diskCache) {
...
//                            return bitmap;
                        	...
                        	if(fileDescriptor!=null){
                        		Bitmap bitmap = ImageUtil.decodeImgFileDescriptor(fileDescriptor);
                        		return bitmap;
                        	}
                        }
                    }
